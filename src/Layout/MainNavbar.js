    ...
    <nav class="navbar navbar-expand-md navbar-dark">
      ...
      <div class="collapse navbar-collapse ml-5" id="navbarText">
        ...
        <form class="form-inline my-2 my-lg-0">
          ...
          <button class="btn btn-outline-light my-2 mr-5 my-sm-0" type="submit">
            Login
          {/* <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-circle mt-2" viewBox="0 0 16 16">
